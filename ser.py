                        ...
                        try:
                            ...
                            async for response in session.receive():
                                ...
                                if response.server_content.turn_complete:
                                    ...
                                    transcribed_text = await transcribe_audio(session.audio_data)
                                    if transcribed_text:
...
async def transcribe_audio(audio_data: bytes) -> str | None:
    ...
    try:
        ...
        response = await transcription_client.generate_content(
            [
                prompt,
                {
                    "mime_type": "audio/mp3",
...
def convert_pcm_to_mp3(pcm_data: bytes) -> str | None:
    ...
    try:
        ...
        with wave.open(wav_buffer, 'wb') as wav_file:
            ...
            wav_file.setframerate(16000)  # Assuming 16kHz for transcription
